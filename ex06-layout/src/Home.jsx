...
class Home extends Component{
    render(){
        return(
            ...
            //     <p>Nice</p>
            // </Fragment>
            // 여러개를 리턴하기 위해 div로 묶었더니.. 중첩이 깊어짐.. 필요 없을 수도 있음
            // 그래서 등장한, 그냥 묶어만 주고 실제 요소가 되지 않는 컴포넌트(화면의 일부 - 파편) : Fragment
            // 단, 실제 요소가 아니기에 스타일 등.. 어떤 속성도 적용할 수 없다.
            // 실제 요소가 아니기에 Fragment 라는 글씨가 보이는 것도 싫다!
            // 쓰지마이씨
                ...
                {/* 레이아웃 연습 (3개의 요소를 배치 - flex 스타일) : styled-components */}
                    ...
                    <Header>
                        ...
                        <div>
                            <span>SAM</span>
                            {/* 이미지파일을 public 폴더 */}
                            <img src="./shutterstock_1844153299-1024x683-1.png" alt="cat" />
                        </div>
